...
urlpatterns = [
    ...
    url(r'^Predict_Cardiac_Arrest_Type/$', remoteuser.Predict_Cardiac_Arrest_Type, name="Predict_Cardiac_Arrest_Type"),
    ...
    url(r'^View_Prediction_Of_Cardiac_Arrest_Type_Ratio/$', serviceprovider.View_Prediction_Of_Cardiac_Arrest_Type_Ratio, name="View_Prediction_Of_Cardiac_Arrest_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Cardiac_Arrest_Type/$', serviceprovider.View_Prediction_Of_Cardiac_Arrest_Type, name="View_Prediction_Of_Cardiac_Arrest_Type"),
